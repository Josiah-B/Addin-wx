...
namespace Stnlist.util
{
    public class GridViewSort
    {
        ...
        private class SortGlyphAdorner : Adorner
        {
            ...
            {
                double x1 = _columnHeader.ActualWidth / 2 - 6;
                double x2 = x1 + 10;
                double x3 = x1 + 5;
                double y1 = _columnHeader.ActualHeight - 10;
                double y2 = y1 + 5;
            ...
            protected override void OnRender(DrawingContext drawingContext)
            {
                ...
                if (_sortGlyph != null)
                {
                    double x = _columnHeader.ActualWidth  / 2 - 6;
                    double y = _columnHeader.ActualHeight - 10;
                    Rect rect = new Rect(x, y, 10, 10);
                    drawingContext.DrawImage(_sortGlyph, rect);
                }
                else
                {
                    drawingContext.DrawGeometry(Brushes.DarkGray, new Pen(Brushes.DarkSlateGray, 1.0), GetDefaultGlyph()); //Old Version
